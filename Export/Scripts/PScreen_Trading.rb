class PokemonTradeScene
 ...
 def pbScene1
    ...
    picturePoke.moveXY(0,1,rsprite1.x-rsprite1.ox,rsprite1.y-rsprite1.oy)
    rsprite1.ox=0
    rsprite1.oy=0
    # Change sprite color
  ...
  def pbScene2
    ...
    picturePoke.moveOrigin(1,pictureBall)#picturePoke.moveOrigin(1,PictureOrigin::Center)
  ...
  def pbEndScreen
    ...
    Kernel.pbMessageDisplay(@sprites["msgwindow"],
       ...
       @pokemon.name,@pokemon.publicID,@pokemon.ot),true,nil)
    100.times do
      Graphics.update
      Input.update
      pbUpdateSceneMap
    ...
    Kernel.pbMessageDisplay(@sprites["msgwindow"],
       _ISPRINTF("{1:s}\r\nID: {2:05d}   OT: {3:s}\1",
       @pokemon2.name,@pokemon2.publicID,@pokemon2.ot),true,nil)
    Kernel.pbMessageDisplay(@sprites["msgwindow"],
       _INTL("Take good care of {1}.",speciesname2),true,nil)
