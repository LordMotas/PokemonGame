...
class ItemCrafterScene
  ...
  def initialize
    ...
    @select=1
    @item=0
    @mat1=0# the index in @materials for the first item
    @mat2=3# the index in @materials for the second item
    @cost1=2# the amount for the first item
    @cost2=2# the amount for the second item
    @amount=1 # the number of items that will be crafted
  ...
  def closeItemCrafterscene
    ...
    def input
      ...
      when 3
        ...
        @sprites["Item_icon"].setBitmap(pbItemIconFile(@items[@item]))
        case @item
        when 0 #Poke Ball - 2 Red (0), 2 White (3)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
            @sprites["Item_1_icon"].setBitmap(pbItemIconFile(@materials[0]))
          ...
          self.text
        when 1 #Great Ball - 2 Blue (1), 4 White (3)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
            @sprites["Item_1_icon"].setBitmap(pbItemIconFile(@materials[1]))
            @sprites["Item_2_icon"].setBitmap(pbItemIconFile(@materials[3]))
            @sprites["Item_1_icon"].opacity=255
            @sprites["Item_2_icon"].opacity=255
            @mat1=1
          ...
          self.text
        when 2 #Ultra Ball - 2 Yellow (2), 8 White (3)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
        ...
        when 3 #Potion - 2 Oran (4)
          ...
          self.text
        when 4 #Super Potion - 1 Sitrus (5), 2 Oran (4)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
          ...
          self.text
        when 5 #Hyper Potion - 2 Watmel (6)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
          ...
          self.text
        when 6 #Max Potion - 1 Enigma (7), 2 Watmel (6)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
            @sprites["Item_1_icon"].setBitmap(pbItemIconFile(@materials[7]))
        ...
        when 7 #Antidote - 1 Pecha (8)
          ...
          self.text
        when 8 #Awakening - 1 Chesto (9)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
            @sprites["Item_1_icon"].setBitmap(pbItemIconFile(@materials[9]))
            @sprites["Item_2_icon"].setBitmap("")
            @sprites["Item_1_icon"].opacity=255
            @sprites["Item_2_icon"].opacity=255
            @mat1=9
          ...
          self.text
        when 9 #Burn Heal - 1 Rawst (10)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
            @sprites["Item_1_icon"].setBitmap(pbItemIconFile(@materials[10]))
            @sprites["Item_2_icon"].setBitmap("")
            @sprites["Item_1_icon"].opacity=255
            @sprites["Item_2_icon"].opacity=255
            @mat1=10
          ...
          self.text
        when 10 #Paralyze Heal - 1 Cheri (11)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
            @sprites["Item_1_icon"].setBitmap(pbItemIconFile(@materials[11]))
            @sprites["Item_2_icon"].setBitmap("")
            @sprites["Item_1_icon"].opacity=255
            @sprites["Item_2_icon"].opacity=255
            @mat1=11
          ...
          self.text
        when 11 #Ice Heal - 1 Aspear (12)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
            @sprites["Item_1_icon"].setBitmap(pbItemIconFile(@materials[12]))
            @sprites["Item_2_icon"].setBitmap("")
            @sprites["Item_1_icon"].opacity=255
            @sprites["Item_2_icon"].opacity=255
            @mat1=12
          ...
          self.text
        when 12 #Full Heal - 1 Lum (13)
          if $canCraft[@item]
            @sprites["unknown"].opacity=0
            @sprites["Item_icon"].opacity=255
            @sprites["Item_1_icon"].setBitmap(pbItemIconFile(@materials[13]))
            @sprites["Item_2_icon"].setBitmap("")
            @sprites["Item_1_icon"].opacity=255
            @sprites["Item_2_icon"].opacity=255
            @mat1=13
