...
module FontInstaller
  ...
  def self.install
    ...
    Kernel.pbMessage(_INTL("The game can be played, but the look of the game's text will not be optimal."))
    failed = false
    ...
    if success.length>0 # one or more fonts successfully installed
      ...
      if Notify
        ...
        if failed
          ...
          Kernel.pbMessage(_INTL("To install the other fonts, copy the files in this game's Fonts folder to the Fonts folder in Control Panel.\1"))
        else
